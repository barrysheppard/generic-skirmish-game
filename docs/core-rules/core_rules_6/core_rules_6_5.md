---
sidebar_label: '6.5 Deployment'
sidebar_position: 6.5
---

# Deployment

The game starts with the action already under way. Rather than lining up at each side of the battle, the three Deployment groups for each Warband are placed on the table based on a randomly selected deployment map.
...
- Fighters are placed on the board during the Reserve phase of the battle round.
...
![Deployment 1](images/image1.png)

**Deployment 2**

![Deployment 2](images/image2.png)

**Deployment 3**

![Deployment 3](images/image3.png)

**Deployment 4**

![Deployment 4](images/image4.png)

**Deployment 5**

![Deployment 5](images/image5.png)

**Deployment 6**

![Deployment 6](images/image6.png)
