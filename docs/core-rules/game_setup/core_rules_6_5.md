...
- Fighters are placed on the board during the deployment phase of the Mission round.
...
![Deployment 4](images/deployment4.png)

**Deployment 5**

![Deployment 5](images/deployment5.png)

**Deployment 6**

![Deployment 6](images/deployment6.png)
